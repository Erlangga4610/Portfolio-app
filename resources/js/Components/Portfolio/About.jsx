            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="lg:text-center mb-12">
                    <motion.h2 
                        ...
                        viewport={{ once: false, amount: 0.5 }} // <-- UBAH KE FALSE
                    ...
                    >
                        <div className="bg-gray-900 rounded-2xl p-8 md:p-12 relative overflow-hidden h-full">
                            ...
                            <div className="relative z-10">
                                ...
                                >
                                    {user.about || "Deskripsi diri belum ditambahkan."}
                                </motion.div>

                                {/* Garis Bawah */}
                                <div className="mt-8 flex items-center gap-2">
                                    <motion.div initial={{ width: 0 }} whileInView={{ width: 80 }} viewport={{ once: false }} transition={{ duration: 0.8, delay: 0.5 }} className="h-1 bg-indigo-500 rounded-full"></motion.div>
                                    <motion.div initial={{ width: 0 }} whileInView={{ width: 20 }} viewport={{ once: false }} transition={{ duration: 0.5, delay: 0.7 }} className="h-1 bg-purple-500 rounded-full"></motion.div>
                                    <motion.div initial={{ width: 0 }} whileInView={{ width: 8 }} viewport={{ once: false }} transition={{ duration: 0.5, delay: 0.9 }} className="h-1 bg-pink-500 rounded-full"></motion.div>
                                </div>
                            </div>
                        </div>
                    </motion.div>
